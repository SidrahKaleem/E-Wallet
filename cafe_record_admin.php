...
<div class="container">
        ...
        <div class="row centered-form">
			...
			<form action="cafe_record_admin.php" method ="post" enctype="multipart/form-data">
			    			<div class="row">
				...
				<h3 class="panel-title">Cafe Records </h3>
					</div>
			 			<div class="panel panel-default">
												
						<?php 
						if(!isset($_POST['view_record']))
						{$rec->view_cafe_sales(null);}
							else
							{
							$rec->view_cafe_sales($_POST['l_username']);
							}
						?>	
