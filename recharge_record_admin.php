...
<html lang="en">
    ...
    <head>
        ...
        <title>View Recharge Record</title>
...
<div class="container">
        ...
        <div class="row centered-form">
			...
			<form action="recharge_record_admin.php" method ="post" enctype="multipart/form-data">
			    			<div class="row">
				...
				<h3 class="panel-title">Recharge Records </h3>
						...
						{$rec->recharge_record_admin(null);}
							else
							{
							$rec->recharge_record_admin($_POST['l_username']);
							}
						?>	
