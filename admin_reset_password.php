...
<div class="container">
       ...
       <div class="panel panel-default">
        		<div class="panel-heading">
			    		...
			    		<form role="form" method="post" action="admin_reset_password.php">
			    			<div class="row">
			    			...
			    			<button href="admin_reset_password.php" type="submit" name="reset_password" class="btn btn-success gradient pull-right"><span class="glyphicon glyphicon-log-in"></span> Proceed</button>
