        ...
        <span class="icon-bar"></span>
					...
					<div class="collapse navbar-collapse pull-right" id="main-menu">
                        <ul class="nav">
                           ...
                           <a href="Shopkeeper.php" class="btn btn-success btn-sm "><span class="glyphicon glyphicon-home"></span> Home</a> 
...
<div class="container">
       ...
       <div class="panel panel-default">
        		<div class="panel-heading">
			    		...
			    		<form role="form" method="post" action="shopkeeper_reset_password.php">
			    			<div class="row">
			    			...
			    			<button href="shopkeeper_reset_password.php" type="submit" name="reset_password" class="btn btn-success gradient pull-right"><span class="glyphicon glyphicon-log-in"></span> Proceed</button>
