...
<html lang="en">
    ...
    <head>
        ...
        <title>Account Activation Record</title>
...
<div class="container">
        ...
        <div class="row centered-form">
			...
			<form action="activation_record_admin.php" method ="post" enctype="multipart/form-data">
			    			<div class="row">
				...
				<h3 class="panel-title">Activation Records </h3>
					</div>
						...
						{
						echo $rec->activation_record_admin(null);
						}
						else
						{
							echo $rec->activation_record_admin($_POST['l_username']);
						}
						?>	
