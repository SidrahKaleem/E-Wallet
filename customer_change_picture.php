        ...
        <span class="icon-bar"></span>
					...
					<div class="collapse navbar-collapse pull-right" id="main-menu">
                        <ul class="nav">
							 ...
							 <a href="Customer.php" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-pencil"></span>Home</a>
...
<div class="container">
        ...
        <div class="row centered-form">
        	...
        	<div class="panel panel-default">
					...
					<form class="form-signin" action="customer_change_picture.php" method ="post" enctype="multipart/form-data" >
	...
	echo "<script> window.location=\"http://localhost/E-Wallet1/customer_change_picture.php\" </script>";
