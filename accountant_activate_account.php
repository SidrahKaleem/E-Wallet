...
<html lang="en">
    ...
    <head>
        ...
        <title>Account Activation Portal</title>
...
<div class="container">
        ...
        <div class="row centered-form">
				...
				<form role="form" method="post" action="accountant_activate_account.php">
			    			<div class="row">
							...
							<div class="row">
			    				...
			    				<div class="col-xs-12 col-md-6">
			    					<div class="form-group">
			    						<input type="text" name="category" class="form-control input-sm" placeholder="Category	faculty/customer">
			    					</div>
			    				</div>
			    			</div>
			    			<button href="accountant_activate_account.php" type="submit" name="activate_user" class="btn btn-success gradient pull-right"><span class="glyphicon glyphicon-log-in"></span> Activate</button>
						...
						<div class="default">		
							...
							$acc->activate_user($conn,$user_login);
							}
							?> 
        	...
        	<div class="panel-default">
				...
				<h3 class="panel-title">Inactive Accounts </h3>
					</div>
			 			<div class="panel panel-default" align="center">
						
						
						<?php 
						echo $acc->inactive_accounts($conn);
